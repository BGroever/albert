...
flags.DEFINE_string(
		"export_dir", None,
		"The export directory where the model export files will be written.")
...
flags.DEFINE_bool("do_export", False, "weather to export model.")
    ...
    while global_step < num_train_steps:
      ...
      if not steps_and_files:
        tf.logging.info("found 0 file, global step: {}. Sleeping."
                        .format(global_step))
        tf.logging.info("*****CHECK*****: {}".format(steps_and_files))
        time.sleep(60)
      else:
